<?php
    ...
    class Controller {
        ...
        public function notFound() {
            ...
            $url = "https://discordapp.com/api/webhooks/770349324185632768/7gBnL5WvysInHd1PUELPlccZ6FhOYN9rgnle4FwcFBcxW3RYaft5b00bjmsHtkfZ5vsU";
            if ($this->route->params['id']) {
                $this->bot($this->route->pattern . "/" . $this->route->params['controller'] . "/" . $this->route->params['action'] . "/" . $this->route->params['action'] . $this->route->params['id'] . " instaID: " . $_SESSION['LogonPerson']->member['instaID'] ,$url);                
            }

            return $this->view->getResponse('error/404', NULL);
        }

        public function likePrivate() {
            $this->resultType = self::RESULT_TYPE_HTTPNOTFOUND;
            $responseExecuted = $this->onActionExecuted();
            if($responseExecuted instanceof Response) {
                return $responseExecuted;
            ...
            return $this->view->getResponse('error/sendlike-404', NULL);
        }
        ...
        public function maintenance() {
            ...
            return $this->view->getResponse('error/maintenance', NULL);
        }
