        ...
        <?php if (is_null($media)) { ?>
            <div class="card px-0 border-0">
                <div class="card-header bg-primary">
                    <div class="row">
                        <div class="col-6">Auto Bookmark</div>
                    ...
                    <div class="card-text">
                        <form method="post" action="?formType=findMediaID" class="form">
                            <div class="form-group mb-3">
                                <label for="autolikes" class="form-label text-muted">Url Post yang ingin di bookmark</label>
                                <input type="text" name="mediaUrl" class="form-control" placeholder="contoh: https://www.instagram.com/p/3H0-Yqjo7u/" required>
                            </div>
                    ...
                    <div class="card-text">
                        <form id="formBegeni" class="form">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="p-2 flex-fill px-0">
                                    <button type="button" id="formBegeniSubmitButton" class="btn btn-primary btn-sm px-4 w-100" onclick="sendBegeni();">
                                        Submit</button>
                                </div>
                            </div>
                        </form>
                            ...
                            <nav class="d-grid gap-2 col-12">
                                ...
                                <a href="#tableHasil" class="btn btn-hover-light d-flex align-items-center gap-3 py-2 px-3 lh-sm">
                                    ...
                                    <div class="text-start">
                                        ...
                                        <small class="text-muted">Post yang berhasil dibookmark</small>
                                    </div>
                                </a>
                                <a href="#" class="btn btn-hover-light d-flex align-items-center gap-3 py-2 px-3 lh-sm">
                                    <i class="fas fa-coins fa-3x me-1"></i>
                                    <div class="text-start">
                                        <strong class="d-block text-success" id="saveCount2">Poin:
                                            <?php echo $logonPerson->member["saveKredi"]; ?></strong>
                ...
                if (data.status == 'error') {
                    ...
                    for (var i = 0; i < data.users.length; i++) {
                        ...
                        if (user.status == 'success') {
                            ...
                            $('#saveCount').html(data.saveKredi);
                            $('#saveCount2').html(data.saveKredi);
