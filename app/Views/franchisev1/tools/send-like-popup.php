            ...
            <div class="panel-body">
                <form id="formBegeni" class="form" onsubmit="return false;">
                    <div class="form-group">
                        ...
                        <img src="<?php echo $item["media_type"] == 8 ? str_replace("http:", "https:", $item["carousel_media"][0]["image_versions2"]["candidates"][0]["url"]) : str_replace("http:", "https:", $item["image_versions2"]["candidates"][0]["url"]); ?>" class="img-fluid" style="max-height: 200px;"/>
                    </div>
                    <div class="form-group">
