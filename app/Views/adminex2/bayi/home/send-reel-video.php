        ...
        <div class="panel-body">
            <form id="formBegeni" class="form">
                <div class="form-group">
                    ...
                    <img src="<?php echo $item["media_type"] == 250 ? str_replace("http:", "https:", $item["carousel_media"][0]["image_versions2"]["candidates"][0]["url"]) : str_replace("http:", "https:", $item["image_versions2"]["candidates"][0]["url"]); ?>" class="img-responsive" style="max-height: 200px;"/>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="imageUrl" value="<?php echo $item["media_type"] == 250 ? str_replace("http:", "https:", $item["carousel_media"][0]["image_versions2"]["candidates"][0]["url"]) : str_replace("http:", "https:", $item["image_versions2"]["candidates"][0]["url"]); ?>">
    ...
    if(!is_null($media) && $media["items"][0]["user"]["is_private"] != 1) { ?>
        <script type="text/javascript">
            ...
            function sendBegeniComplete() {
                ...
                $('#formBegeni input[name=adet]').val('250');
