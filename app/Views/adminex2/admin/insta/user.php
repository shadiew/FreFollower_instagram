                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if($userInfo["is_private"] != 1) { ?>
                            ...
                            <li>
                                <a href="#modalPopup" data-toggle="modal" onclick="sendPopup('<?php echo $userInfo["pk"]; ?>','canli-yayin-view');">Canlı Yayına izlenme Gönder</a>
    <li>
                                <a href="#modalPopup" data-toggle="modal" onclick="sendPopup('<?php echo $userInfo["pk"]; ?>','canli-yayin-like');">Canlı Yayına beğeni Gönder</a>
                            </li>
                            <li>
