...
?>
    ...
    <div class="alert alert-info">
        ...
        <p>Görev tanımlarken komut satırına eklemeniz gereken kod şu şekildedir:<br/><strong>curl -s -m 180 -H "CronJobToken: <?php echo md5(Wow::get("project/cronJobToken")); ?>" http<?php echo Wow::get("project/onlyHttps") ? 's' : ''; ?>://<?php echo $_SERVER['SERVER_NAME'];
