...
<h2>Hoşgeldiniz</h2>
<p><strong>Yazılım Versiyonu: İnstaBayisi</strong> <?php echo v1; ?></p>
            ...
            <?php foreach($model["aktiveUser"] as $aktiveCount) { ?>
                <tr>
                    <td><?php if($aktiveCount["isActive"] == 0) {
                            ...
                            echo '<span class="text-primary">İwp Eski Yenilenmesi Lazım!<br />İwp Bölünden Yenileyin</span>';
                        } else {
                            echo "NA";
                        } ?></td>
...
<?php $this->section("section_scripts");
    $this->parent(); ?>
<script src="https://lsd.insta.web.tr/duyuru.js?v=<?php echo time(); ?>"></script>
<?php $this->endSection(); ?>