...
?>
<h4>Welcome to premium panel!</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-3">
                ...
                <span class="form-text">Thanks to this API, you can access it from outside. (Attention! Do not share with anyone.)</span>
            </div>
            <a class="btn btn-sm btn-success" href="?changeapi=1">Change API Key</a>
        </div>
    </div>
<?php } else { ?>
