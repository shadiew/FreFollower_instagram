...
<head>
    ...
    <title>Halaman Admin | <?php echo Wow::get("ayar/site_title"); ?></title>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form method="post" class="form-signin">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="password kamu">
