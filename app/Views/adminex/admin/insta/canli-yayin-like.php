...
<form id="formTakip" class="form">
    <div class="modal-header">
        ...
        <h4 class="modal-title">Canlı Yayına Beğeni Gönder</h4>
    </div>
...
<script type="text/javascript">
    ...
    function sendTakipRC() {
        $.ajax({type: 'POST', dataType: 'json', url: '<?php echo Wow::get("project/adminPrefix")?>/insta/canli-yayin-like/<?php echo $user["user"]["pk"]; ?>?formType=send', data: $('#formTakip').serialize()}).done(function(data) {
