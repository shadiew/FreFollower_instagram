<?php
	...
	class Helpers {
		...
		public function getMediaID($permalink) {
			$json = file_get_contents("https://i.instagram.com/oembed?url=".$permalink);
		...
		public function convertMinuteToDuration($minutes)
	{
		$hours = "";
		$days = "";
		if ($minutes < 60) {
	...
	public function dateTimeToDuration($datetime)
	{
		...
		if ((int)$days != 0) {
			...
			return $interval->format('%i mins ago');
		}
