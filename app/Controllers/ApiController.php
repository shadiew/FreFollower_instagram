                    ...
                    if(!empty($link) && !empty($quantity)) {
                        ...
                        if(empty($arrErrors)) {
                            ...
                            if(count($getItems["reel"]["items"]) < 1) {
                                $arrErrors = "Kullanıcının aktif bir story paylaşmı bulunmamaktadır!";
                            }
                        ...
                        if(empty($arrErrors)) {
                            ...
                            if(!isset($broadcast["broadcast"]["id"])) {
                                $sonuc = array(
                                    "status"  => "error",
                                    "code"    => "nolimitdefined",
                                    "message" => "Canlı Yayn Bulunamadı. Kişinin aktif canlı yayını bulunamadı!",
                                    "users"   => array()
                                );
